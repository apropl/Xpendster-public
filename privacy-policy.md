...
- **Cloud Firestore**: Stores your app data in the cloud
  - Privacy Policy: https://firebase.google.com/support/privacy
  - Data is stored securely and encrypted in transit and at rest

- **Firebase Cloud Messaging (FCM)**: Sends push notifications
  - Privacy Policy: https://firebase.google.com/support/privacy
  - Collects FCM tokens to deliver notifications

### 2. Google Sign-In
- **Credential Manager API**: Enables Google Sign-In authentication
  - Privacy Policy: https://policies.google.com/privacy
  - Collects email address and basic profile information with your consent
...
### Account Deletion
- To delete your account, contact us or use the account deletion feature in the App
- Account deletion will remove your data from our servers, but data in shared plans may remain

## Permissions We Request

### Camera Permission
- **Purpose**: To scan QR codes for plan invitations
- **When Used**: Only when you choose to scan a QR code
- **Data**: We do not store or transmit any images captured by the camera
- **Required**: Yes, for QR code scanning feature
...
**Note**: This privacy policy template should be customized with your specific contact information and reviewed by a legal professional to ensure compliance with all applicable laws in your jurisdiction.
